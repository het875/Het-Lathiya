...
export const personalInfo: PersonalInfo = {
  ...
  headline: "Passionate about building efficient backend solutions with expertise in Python, FastAPI, web scraping and Financial Systems. I solve complex problems with multiple innovative approaches.",
...
export const coreCompetencies: CoreCompetency[] = [
  ...
  {
    name: "Web Scraping",
    description: "Advanced web scraping using multiple libraries and frameworks for data extraction"
  },
  {
...
export const experiences: Experience[] = [
  {
    ...
    technologies: ["Python", "FastAPI", "Django", "BeautifulSoup", "Microservices", "Webhooks", "NSE/BSE APIs"]
  },
  {
    ...
    technologies: ["Django", "PostgreSQL", "Kafka", "Docker", "WhatsApp API", "Barcode Systems", "Maps Integration"]
  },
  {
...
export const projects: Project[] = [
  {
    ...
    description: "A full-fledged system for managing water purifier services across multiple organizations with QR-based tracking.",
    longDescription: "A comprehensive service management platform that handles water purifier maintenance across multiple organizations. Features include service request tracking, QR code validation, customer feedback systems, and administrative dashboards.",
  ...
  },
  {
    ...
    longDescription: "An internship project focused on creating a rental dress booking system with inventory management and user authentication.",
  ...
  },
  {
    ...
    longDescription: "A dynamic data visualization platform built with Streamlit for real-time analytics and interactive charting.",
  ...
  },
  {
    ...
    description: "An end-to-end hotel management platform covering booking, customer service, HR, and reporting.",
    longDescription: "A comprehensive hotel management solution that handles all aspects of hotel operations from booking to HR management.",
  ...
  },
  {
    ...
    description: "A production-grade system to scrape, manage, and analyze IPO data from 2019–2025.",
    longDescription: "A robust data extraction and analysis system for IPO data with comprehensive error handling and data validation.",
  ...
  },
  {
    ...
    longDescription: "A comprehensive stock market data platform with real-time scraping capabilities and RESTful API services.",
